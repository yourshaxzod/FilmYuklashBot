...
class Button {
    ...
    public const TRENDING = "🔥 Trendlar";
    ...
    // ADM
    public const MOVIE = "🎬 Kinolar";
    public const CHANNEL = "🔐 Kanallar";
    public const STATISTIC = "📊 Statistika";
    ...
    public const CANCEL = "🚫 Bekor qilish";
}